...
Status: SP-000 through SP-011 and CI-001 are merged. The owner authorized SP-012 on 2026-09-26; implementation is tracked in Issue #27 and PR #28. Later feature tasks still require normal one-task-at-a-time authorization.
...
SP-007 merged via PR #18 at `efd87540435624dcd8af52495f6675a1ff2cdb1f`. SP-008 merged via PR #20 at `e5fc0e9860628190e1cf0e78bcc8b67a62cea8b4`. SP-009 merged via PR #22 at `41bcc69edae80a8e8337d6920231e504d81a9e1a`. SP-010 merged via PR #24 at `7f9d6282a16fb30e4c61e3baf7300550c3b6f0e5` with post-merge CI verified. SP-011 merged via PR #26 at `594ad8b3958f64fa274c2debdf542364e589f6aa`; post-merge CI run `36150363815` passed. SP-012 is the active approved task in [Issue #27](https://github.com/Sherko231/sherko_pharma/issues/27) and [PR #28](https://github.com/Sherko231/sherko_pharma/pull/28): refresh relevant catalog/order data without a full catalog replica and handle server price changes explicitly. See [development status](DEVELOPMENT_STATUS.md) for live evidence.
