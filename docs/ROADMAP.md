...
Status: SP-000 through SP-012 and CI-001 are merged. SP-013 is implemented in Issue #29 and PR #30; current-revision CI passed and the owner accepted the real Android camera behavior on 2026-09-26. Final merge and post-merge CI verification remain. Later feature tasks still require normal one-task-at-a-time authorization.
